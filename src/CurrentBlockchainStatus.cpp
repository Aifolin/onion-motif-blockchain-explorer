...
CurrentBlockchainStatus::load_current_emission_amount()
{
    ...
    string last_saved_emmision = mtfeg::read(emmision_saved_file);
...
bf::path CurrentBlockchainStatus::blockchain_path {"/home/mwo/.bitmotif/lmdb"};
...
mtfeg::MicroCore*  CurrentBlockchainStatus::mcore {nullptr};
}
