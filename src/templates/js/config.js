var config = {
    ...
    coinUnitPlaces: 12,
    txMinConfirms: 10,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in Motif
    txCoinbaseMinConfirms: 60, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in Motif
    coinSymbol: 'MTF',
    openAliasPrefix: "mtf",
    coinName: 'Motif',
    coinUriPrefix: 'motif:',
